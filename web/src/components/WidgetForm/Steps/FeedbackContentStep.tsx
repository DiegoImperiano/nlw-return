    ...
    <form onSubmit={handleSubmitFeedback} className="w-full my-4">
      ...
      <footer className="flex gap-2 mt-2">
        ...
        <button 
          ...
          className="items-center justify-center flex-1 p-2 text-sm transition-colors border-transparent rounded-md bg-brand-500 hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-zinc-900 focus:ring-brand-500 disabled:opacity-50 disabled:hover:bg-brand-500">
          Enviar feedback
